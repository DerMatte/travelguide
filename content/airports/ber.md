...
sources:
  ...
  - "https://ber.berlin-airport.de/en/flying/controls/security-control.html"
quickFacts:
...
- Lufthansa Group Fast Lane (Miles & More Frequent Traveller/Senator/HON plus LH Group business/first) uses a dedicated lane — compare live wait times against CT checkpoints on the BER app before joining any queue.
...
- **BER Runway ended 26 May 2026:** Slot booking for the legacy Runway checkpoint is discontinued ([BER notice](https://ber.berlin-airport.de/de/news/2026-05-21-anpassung-siko.html)). Use CT lanes (areas 1 and 5 in T1) where liquids up to **2 L** and electronics stay in bags; legacy X-ray lanes at the old Runway site remain until autumn refit.
...
- Multiple security control areas in T1 (and T2) all reach every gate — pick the shortest queue on monitors, not the nearest door.
...
- S-Bahn line S9 is cheaper (€3.80 with AB ticket) and runs about every 20 minutes.
...
- https://www.berlin-airport.de/en/passengers/departures-arrivals/index.php
- https://www.bvg.de/en
- [BER security control areas](https://ber.berlin-airport.de/en/flying/controls/security-control.html)
- [BER Runway slot booking ended 26 May 2026](https://ber.berlin-airport.de/de/news/2026-05-21-anpassung-siko.html)
