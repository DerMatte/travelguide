...
- **Paris Region <> Airports ticket** (required for RER B to/from CDG) costs **€14** full fare / **€7** reduced from **1 Jan 2026** — load on Navigo Easy or buy via the Île-de-France Mobilités app ([RATP](https://www.ratp.fr/en/titres-et-tarifs/ticket-paris-region-aeroports)).
...
- RER B is best value with the **€14** Paris Region <> Airports ticket; official taxi flat fares to central Paris are **€56** (right bank) / **€65** (left bank) in 2026.
- Valet parking at Terminal 2 saves time but costs €45+ per day; long-term P3/P4 lots are cheaper via shuttle.
- Avoid unofficial rides at arrivals — use the official taxi queue.
...
- [RER B schedules (RATP)](https://www.ratp.fr/en)
