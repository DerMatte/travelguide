...
- Rideshare pickup zones on the **upper (departures) level at every terminal** — follow app pin for door number; staging lot queues affect wait time more than terminal choice.
