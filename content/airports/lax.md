...
quickFacts:
  - "Terminals 1–4, 6–8 plus Tom Bradley International (Terminal B / TBIT); Terminal 5 closed for rebuild (Oct 2025–~2028)"
...
## Quick Facts
- **Layout:** Terminals **1–4, 6–8** plus **Tom Bradley International Terminal (Terminal B / TBIT)** — main TBIT concourse plus **West Gates** satellite linked by an underground tunnel (~**15 min** walk gate-to-gate per airport guides). **Terminal 5 closed** for demolition/rebuild on **28 Oct 2025**; reopen targeted before the **2028 Olympics** ([LAWA T5 closure](https://www.lawa.org/news-releases/2025/LAX%20ANNOUNCES%20TERMINAL%205%20CLOSURE%20TO%20MAKE%20WAY%20FOR%20MAJOR%20TRANSFORMATION)).
...
- **North cluster (T1–T3 + TBIT):** **T1** (Southwest, **JetBlue** — moved from T5 Oct 2025, Frontier, others), **T2** (**Spirit** — moved from T5 Oct 2025, LATAM, Virgin Atlantic, Norse, others), **T3** (Delta hub), **TBIT** (most long-haul international). Connected airside via **T1.5**, **T2–T3** walkways, and **T3–TBIT** bridge.
- **South cluster (T4, T6–T8):** **T4** (American — consolidated from T5 Oct 2025), **T6** (Alaska, Air Canada, Hawaiian), **T7–T8** (United). **Terminal 5 is closed** for rebuild — do not follow old T5 gate assignments. Connected airside via tunnels and walkways; **TBIT** links via skybridge to **T4**.
...
- [LAWA Terminal 5 closure (Oct 2025)](https://www.lawa.org/news-releases/2025/LAX%20ANNOUNCES%20TERMINAL%205%20CLOSURE%20TO%20MAKE%20WAY%20FOR%20MAJOR%20TRANSFORMATION)
- Re-check terminal, gate area (**West Gates** vs main TBIT), airline location after **T5 closure**, and construction notices before every trip.
