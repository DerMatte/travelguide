...
quickFacts:
  - "Two terminals (T1 domestic-heavy, T2 international/Aeromexico) 8 km apart"
  - "Free shuttle bus runs every 10-15 min between T1 and T2"
  - "Aeromexico hub; major international carriers in T2"
  - "Security lines often exceed 45 min during morning and evening peaks"
  - "Metro Line 5 reaches T1 in 25 min from city center; no direct rail to T2"
bentoTips:
  - category: "timing"
    label: "Timing"
    title: "Arrive 3 hours early"
    summary: "International flights from T2 routinely hit 60-minute security queues."
    detail: "Domestic T1 is faster but still add buffer during 6-10 a.m. and 6-9 p.m. rushes."
  - category: "terminal"
    label: "Transfers"
    title: "Ride the free shuttle"
    summary: "Take the red shuttle bus between T1 and T2 instead of a taxi."
    detail: "Runs 24/7; avoid walking or paid transfers that add 20+ minutes and cost."
  - category: "food"
    label: "Food & quiet"
    title: "Eat in T2 departures"
    summary: "Grab superior food and seating airside in T2 after security."
    detail: "T1 landside options are limited and crowded; T2 has better variety and quieter gates."
  - category: "status"
    label: "Live checks"
