...
quickFacts:
  - "Three terminals: T1 (domestic/low-cost), T2 (SkyTeam + many int'l), T3 (Air China/Star Alliance + most long-haul)"
...
bentoTips:
  ...
  - category: "terminal"
    ...
    detail: "T2↔T3 transfers require the free landside shuttle — there is no airside walkway."
  - category: "food"
    label: "Food & quiet"
...
- **MCT (same ticket):** **90 min** T2↔T3 minimum including landside shuttle; **2 h** safer — all passengers re-clear security on connections.
- T3 handles most international and Star Alliance (Air China) flights; T2 serves SkyTeam and many other carriers.
...
- Use the free **landside shuttle** between T2 and T3 — there is **no airside walkway**; allow **15–20 min** including wait.
...
- **No airside link** between T2 and T3 — always use the shuttle and re-clear security at your departure terminal.
