...
quickFacts:
  ...
  - "Free unlimited Wi-Fi, 24-hour cinemas (T3), and gardens across terminals"
  - "Butterfly Garden is in Terminal 3 only — world's first airport butterfly habitat"
...
- Free 24-hour **movie theatre in T3** (Level 3 Transit Central), gardens, and gaming zones available airside.
- **Butterfly Garden** is in **Terminal 3 only** (Transit Level 2/3) — use Skytrain from other terminals ([Changi Butterfly Garden](https://www.changiairport.com/en/experience/attractions-directory/butterfly-garden.html)).
...
- Watch a movie in the **free 24-hour cinema in T3** when layover exceeds 3 hours — closed Thursdays 11:00–16:00 for maintenance ([Changi movie theatre](https://www.changiairport.com/en/at-changi/facilities-and-services-directory/movie-theatres.html)).
- Visit the **Butterfly Garden in T3** (not in every terminal) — Skytrain from T1/T2/T4 if needed.
...
- [Butterfly Garden (T3)](https://www.changiairport.com/en/experience/attractions-directory/butterfly-garden.html)
- [Movie Theatre (T3)](https://www.changiairport.com/en/at-changi/facilities-and-services-directory/movie-theatres.html)
- [Civil Aviation Authority of Singapore](https://www.caas.gov.sg/)
